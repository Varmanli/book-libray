...
test("strict URL validation accepts only exact HTTPS IranKetab book paths",()=>{
  ...
  for(const value of ["http://iranketab.ir/book/1-test","https://u:p@iranketab.ir/book/1-test","https://iranketab.ir:444/book/1-test","https://evil-iranketab.ir/book/1-test","https://iranketab.ir.example.com/book/1-test","https://127.0.0.1/book/1-test","https://iranketab.ir/profile/1-test","https://iranketab.ir/book/%31-test"]){assert.throws(()=>validateIranKetabBookUrl(value));}
});
